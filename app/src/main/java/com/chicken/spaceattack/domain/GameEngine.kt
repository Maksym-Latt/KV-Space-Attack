...
class GameEngine {
    ...
    private val formationColumns = 5

    private val levelConfigs =
            listOf(
                    LevelConfig(level = 1, smallEnemies = 5, mediumEnemies = 0),
                    LevelConfig(level = 2, smallEnemies = 8, mediumEnemies = 1),
                    LevelConfig(level = 3, smallEnemies = 10, mediumEnemies = 5),
                    LevelConfig(level = 4, smallEnemies = 8, mediumEnemies = 8),
                    LevelConfig(level = 5, smallEnemies = 10, mediumEnemies = 10),
                    LevelConfig(level = 6, smallEnemies = 5, mediumEnemies = 15),
                    LevelConfig(
                            level = 7,
                            smallEnemies = 0,
                            mediumEnemies = 0,
